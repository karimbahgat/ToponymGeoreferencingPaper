...
#automap('testmaps/korean_war_april_1951.jpg', textcolor=(0,0,0), colorthresh=40, db=db, debug=True)

#automap('testmaps/zaire_map.jpg', textcolor=(0,0,0), db=db, debug=True)
...
automap('testmaps/france_admin91.jpg', textcolor=(0,0,0), colorthresh=25, db=db, debug=True)
